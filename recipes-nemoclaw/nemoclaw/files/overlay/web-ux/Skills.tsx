...
//
// Skills browser page for nclawzero web UX.
...
nclawzero skills install clawhub:weather
nclawzero skills install clawhub:memory

# Install from GitHub
nclawzero skills install https://github.com/user/skill

# List installed
nclawzero skills list`}
          </pre>
        </div>
      </div>
    );
        ...
        <div className="card p-8 text-center">
          ...
          <p style={{ color: 'var(--pc-text-muted)' }}>
            ...
            <code className="text-xs px-1 py-0.5 rounded" style={{ background: 'var(--pc-bg-base)' }}>
              nclawzero skills install clawhub:name
            </code>
          </p>
        </div>
      ) : (
